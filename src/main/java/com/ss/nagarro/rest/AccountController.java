...
public class AccountController {
    ...
    public AccountStatementResposne getAccountStatement(@RequestBody AccountStatementRequest request) throws InvalidRequestException, AuthorizationException {
        ...
        List<String> roles = SecurityContextHolder.getContext().getAuthentication().getAuthorities().stream().map(authority -> authority.getAuthority()).collect(Collectors.toList());
